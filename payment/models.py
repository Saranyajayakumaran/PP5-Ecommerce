...
class Checkout(models.Model):
    """
    Model to store all the informations about user
    who purchasing
    """
    ...
    def generate_order_number(self):
        """
        Generate 32 characters of random number
        which is a unique order number UUID
        """
        return uuid.uuid4().hex.upper()

    def update_total(self):
        """
        Grand total will be updated each time
        an item is added with delivery cost
        """
