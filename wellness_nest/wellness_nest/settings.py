"""
Django settings for wellness_nest project.
...
ALLOWED_HOSTS = ['https://pp5-wellnessnest-96adb2a059a0.herokuapp.com/','localhost.com','127.0.0.1']
...
DEFAULT_FROM_EMAIL = 'wellnessnest@example.com'
